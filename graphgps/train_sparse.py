...
from layer import GraphGPSLayer,SparseMHA
...
class GraphGPSModel(nn.Module):
    def __init__(
        ...
        self.layers = nn.ModuleList(
            [GraphGPSLayer(hidden_size, num_heads) for _ in range(num_layers)]
        )
...
if __name__ == "__main__":
    ...
    model = GraphGPSModel(out_size=out_size, pos_enc_size=pos_enc_size).to(dev)
